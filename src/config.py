...
class EnvConfig:
    ...
    def __init__(self):
        ...
        self.youtube_stream_url = os.getenv(
        ...
        self.discord_message = os.getenv(
        ...
        # Audio device (Windows only) - now optional
        self.audio_device = os.getenv("AUDIO_DEVICE", "Stereo Mix (Realtek(R) Audio)")
        self.enable_audio = os.getenv("ENABLE_AUDIO", "false").lower() == "true"
